...
function generateServiceMethod(endpoint) {
    ...
    return "\nasync ".concat(endpoint.function, "() {\n  try {\n    ").concat(((_a = endpoint.return[200]) === null || _a === void 0 ? void 0 : _a.data)
        ? "return await this.prisma.".concat(endpoint.return[200].data.prisma.model, ".").concat((_b = endpoint.return[200].data) === null || _b === void 0 ? void 0 : _b.prisma.action, "({\n            ").concat(((_c = endpoint.return[200].data) === null || _c === void 0 ? void 0 : _c.prisma.args.select)
            ? "select: ".concat(JSON.stringify((_d = endpoint.return[200].data) === null || _d === void 0 ? void 0 : _d.prisma.args.select))
            : "").concat(((_e = endpoint.return[200].data) === null || _e === void 0 ? void 0 : _e.prisma.args.include)
            ? ",\ninclude: ".concat(JSON.stringify((_f = endpoint.return[200].data) === null || _f === void 0 ? void 0 : _f.prisma.args.include))
            : "").concat(((_g = endpoint.return[200].data) === null || _g === void 0 ? void 0 : _g.prisma.args.skip)
            ? ",\nskip: ".concat((_h = endpoint.return[200].data) === null || _h === void 0 ? void 0 : _h.prisma.args.skip)
            : "").concat(((_j = endpoint.return[200].data) === null || _j === void 0 ? void 0 : _j.prisma.args.take)
            ? ",\ntake: ".concat(endpoint.return[200].data.prisma.args.take)
            : "").concat(((_k = endpoint.return[200].data) === null || _k === void 0 ? void 0 : _k.prisma.args.orderBy)
            ? ",\norderBy: ".concat(JSON.stringify((_l = endpoint.return[200].data) === null || _l === void 0 ? void 0 : _l.prisma.args.orderBy))
            : "").concat(((_m = endpoint.return[200].data) === null || _m === void 0 ? void 0 : _m.prisma.args.where)
            ? ",\nwhere: ".concat(JSON.stringify((_o = endpoint.return[200].data) === null || _o === void 0 ? void 0 : _o.prisma.args.where))
            : "", "\n          })")
